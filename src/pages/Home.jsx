        ...
        <div className="flex ">
          <div className="flex flex-col md:flex-row">
            <div className="flex-1 ">
              <h1 className="ml-12 md:ml-28 mt-10 md:mt-32 text-6xl text-white  font-semibold">
                Modern Interior
              </h1>
              <h1 className="ml-12 mt-4 mb-11 md:mb-12 leading-10 text-6xl text-white font-semibold md:ml-28">
                Design
              </h1>
              <p className="text-white ml-12 md:ml-28 max-w-96 text-xl ">
